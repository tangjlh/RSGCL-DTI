...
import RSGCL.data.utils
from RSGCL.data import set_cache_mol, empty_cache
from RSGCL.features import get_available_features_generators
...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        global temp_dir
        self.smiles_columns = RSGCL.data.utils.preprocess_smiles_columns(
            path=self.data_path,
        ...
        for metric in self.metrics:
            if not (self.dataset_type == 'classification' and metric in ['auc', 'prc-auc', 'accuracy',
