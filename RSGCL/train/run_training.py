...
from RSGCL.models.pretrain import pre_train
from RSGCL.args import TrainArgs
from RSGCL.constants import MODEL_FILE_NAME
from RSGCL.data import get_class_sizes, MoleculeDataLoader, MoleculeDataset, set_cache_graph, split_data
from RSGCL.models import InteractionModel
from RSGCL.utils import build_lr_scheduler, get_loss_func, load_checkpoint, makedirs, \
...
def run_training(args: TrainArgs,
    ...
    for model_idx in range(args.ensemble_size):
        ...
        best_epoch, n_iter, patient = 0, 0, 0

        drug_rep, pro_rep = pre_train(save_dir)
        for epoch in trange(args.epochs):
            ...
            if args.minimize_score and avg_val_score < best_score or \
                ...
                best_score, best_epoch, patient = avg_val_score, epoch, 0
