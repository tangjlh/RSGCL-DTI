...
from RSGCL.data import StandardScaler, MoleculeDataset, preprocess_smiles_columns, get_task_names
from RSGCL.models import InteractionModel
from RSGCL.nn_utils import NoamLR
...
def load_checkpoint(path: str,
                    ...
                    logger: logging.Logger = None) -> InteractionModel:
    ...
    debug('Loading pretrained parameter.')
